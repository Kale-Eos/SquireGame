...
public class Sound
{
    ...
    [Range(0.1f, 3f)]               // range of sound speed from 1-300%
    public float pitch = 1f;        // auto set to 100%
    [Range(0f, 0.5f)]               // range of 0-0.5% fluctuation
...
public class AudioManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            GameObject _go = new GameObject("Sound_" + i + "_" + sounds[i].name);       // creates temp gameobject of sounds
